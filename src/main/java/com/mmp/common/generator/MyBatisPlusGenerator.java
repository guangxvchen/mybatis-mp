package com.mmp.common.generator;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        //2. 定义数据源配置
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/api?characterEncoding=utf8&useSSL=false&serverTimezone=UTC")
